	...
	<fieldset style="background: #bdd5fb ; padding: 20px">
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				...
				<input style="width: 300px" id="name" name="name" type="text" placeholder="Họ và Tên" class="form-control input-md" value="{{ $address->name }}">
			</div>
...
<div class="form-group">
	...
	<div class="col-md-4">
		...
		<div class="input-group">
			...
			<input style="width: 300px" id="address" name="address" type="text" placeholder="Địa chỉ" class="form-control input-md" value="{{ $address->addressde}}">
		</div>
...
<div class="form-group">
	...
	<div class="col-md-4">
		<div class="input-group">
			...
			<input style="width: 300px" id="phone" name="phone" type="text" placeholder="Số điện thoại" class="form-control input-md" value="{{ $address->phone }}">
